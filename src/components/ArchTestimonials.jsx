...
const ArchTestimonials = () => {
  return (
    <section className="arch-test-section">
      <div className="arch-test-container">
        
        <div className="arch-test-header">
          <span className="test-badge">CLIENT SUCCESS</span>
          <h2 className="test-title">Delivering Certified Structural Designs</h2>
          <p className="test-subtitle">
            Leading architects, developers, and facility managers recommend Tesco for optimized calculations and aesthetic designs.
          </p>
        </div>

        <div className="arch-test-grid">
...
export default ArchTestimonials;
