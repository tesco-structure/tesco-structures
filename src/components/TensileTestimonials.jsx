...
import './TensileTestimonials.css';
...
const TensileTestimonials = () => {
  return (
    <section className="tensile-test-section">
      <div className="tensile-test-container">
        
        <div className="tensile-test-header">
          <span className="test-badge">CLIENT SUCCESS</span>
          <h2 className="test-title">Delivering Value Across Modern Spaces</h2>
          <p className="test-subtitle">
            Businesses and developers trust our tensile roofing solutions for iconic design, robust safety, and flawless finish.
          </p>
        </div>

        <div className="tensile-test-grid">
...
export default TensileTestimonials;
